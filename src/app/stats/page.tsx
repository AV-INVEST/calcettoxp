    ...
    <main className="min-h-screen bg-bgPrimary text-textPrimary pb-28">
      <div className="max-w-7xl mx-auto px-5 py-6 md:py-10">
        ...
        <section className="pt-4">
          <PersonalRecordsCard
            input={{
              profile: { careerIndex: player.careerIndex, ovr: player.ovr },
              matches: allMatches.map((m) => ({
                id: m.id,
                goals: m.goals,
                assists: m.assists,
                result: m.result,
                matchDate: m.playedAt,
              ...
              seasons: playerSeasons.map((ps) => ({
                ...
                key: ps.seasonKey,
                label: ps.label,
                startAt: ps.startDate,
                endAt: ps.endDate,
                matches: ps.matchesPlayed,
                wins: ps.wins,
                goals: ps.goals,
                careerIndexEnd: ps.endCareerIndex ?? ps.startCareerIndex,
                careerIndexStart: ps.startCareerIndex,
              })),
              isPro,
            }}
            isPro={isPro}
